...
import { PlayerUpdateMessage, RoomJoinMessage, RoomMessage, RoomPlayerChatMessage, WsMessagesName } from '@petit-bac/ws-shared';
...
export class SocketService {
  ...
  sendRoomMessage(type: WsMessagesName.ROOM_JOIN, payload: WithoutRoomId<RoomJoinMessage>): Observable<unknown>;
  sendRoomMessage(type: WsMessagesName.ROOM_PLAYER_CHAT, payload: WithoutRoomId<RoomPlayerChatMessage>): Observable<unknown>;
  sendRoomMessage(type: WsMessagesName, payload: WithoutRoomId<RoomMessage>): Observable<unknown> {
